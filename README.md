...
这本书正好能够解决我近期碰到的问题。[源码](https://github.com/luoweifu/PyDesignPattern)，看完了设计原则一章。设计模式准备看几个经典的，深入研究透彻，其他模式就不看了，看了记不住也用不上，兼顾深度和广度，也是学习的一个方法，🔖mark一下。

💡💡**[按照这个人的思路把篮球的模型梳理一下](https://zhuanlan.zhihu.com/p/25742261)**

[所写所得即所想](https://github.com/datawhalechina/joyful-pandas)

先把入门的比赛参加一遍吧

参加NCAA的kaggle比赛

​	[google的一个服务](https://datastudio.google.com/reporting/1gh6NGVURB3gMcwfh1Ubob474biePAw3U/page/TTCk)

​	[高级篮球模型](https://www.kaggle.com/virtonos/advanced-basketball-analytics)

sklearn库的学习

[新手如何入门pytorch？](https://www.zhihu.com/question/55720139/answer/147148105)

[深度学习框架电子书](https://github.com/chenyuntc/pytorch-book)
...
这个其实放到使用python小技巧里面，属于锦上添花的功能，现阶段不需要。
...
资源库里面有个pandas_exerices的pandas联系题，刷完了，但是有些地方还是记不太住，又梳理了一下。
...
[pinnacle说明展示文档](https://pinnacleapi.github.io/)
